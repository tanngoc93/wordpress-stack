...
define( 'DB_NAME',     getenv_docker('WORDPRESS_DB_NAME', getenv_docker('WORDPRESS_APP1_DB_NAME', 'wordpress_site1')) );
 ...
 */
$table_prefix = getenv_docker('WORDPRESS_TABLE_PREFIX', getenv_docker('WORDPRESS_APP1_TABLE_PREFIX', 'wp1_'));
